   ...
   return(
       ...
       >
        ...
        <path d="M4.88649 19.1393H48.1273L53 45.5696H0L4.88649 19.1393Z" fill="#B9B9B9"/>
           <path d="M46.931 21.8734C46.931 33.1216 37.7875 42.2468 26.5 42.2468C15.2125 42.2468 6.06897 33.1216 6.06897 21.8734C6.06897 10.6252 15.2125 1.5 26.5 1.5C37.7875 1.5 46.931 10.6252 46.931 21.8734Z" fill="black" stroke="white" {strokeWidth:"3"}/>
