export default function Fader({marginTop,marginLeft, gridArea}){
    return(
        ...
        >
            ...
            <rect x="1.5" y="107.382" width="17" height="17" rx="6.5" fill="#B9B9B9" stroke="white" strokeWidth="3"/>
            <rect x="1.5" y="101.5" width="17" height="17" rx="6.5" fill="black" stroke="white" strokeWidth="3"/>
        </svg>
    )
}
